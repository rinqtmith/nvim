...
_G.packer_plugins = {
  ...
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/bufdelete.nvim",
  ...
  ["cheatsheet.nvim"] = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/cheatsheet.nvim",
  ...
  ["nvim-bqf"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/nvim-bqf",
